...
export const ZDO_REQ_CLUSTER_ID_TO_ZIGATE_COMMAND_ID: Readonly<Partial<Record<ZdoClusterId, BlzCommandCode>>> = {
    [ZdoClusterId.NETWORK_ADDRESS_REQUEST]: BlzCommandCode.NwkAddress,
    [ZdoClusterId.IEEE_ADDRESS_REQUEST]: BlzCommandCode.IEEEAddress,
    [ZdoClusterId.NODE_DESCRIPTOR_REQUEST]: BlzCommandCode.NodeDescriptor,
    [ZdoClusterId.POWER_DESCRIPTOR_REQUEST]: BlzCommandCode.PowerDescriptor,
    [ZdoClusterId.SIMPLE_DESCRIPTOR_REQUEST]: BlzCommandCode.SimpleDescriptor,
    [ZdoClusterId.MATCH_DESCRIPTORS_REQUEST]: BlzCommandCode.MatchDescriptor,
    [ZdoClusterId.ACTIVE_ENDPOINTS_REQUEST]: BlzCommandCode.ActiveEndpoint,
    [ZdoClusterId.SYSTEM_SERVER_DISCOVERY_REQUEST]: BlzCommandCode.SystemServerDiscovery,
    [ZdoClusterId.BIND_REQUEST]: BlzCommandCode.Bind,
    [ZdoClusterId.UNBIND_REQUEST]: BlzCommandCode.UnBind,
    [ZdoClusterId.LQI_TABLE_REQUEST]: BlzCommandCode.ManagementLQI,
    // [ZdoClusterId.ROUTING_TABLE_REQUEST]: BlzCommandCode.ManagementRtg,
    // [ZdoClusterId.BINDING_TABLE_REQUEST]: BlzCommandCode.ManagementBind,
    [ZdoClusterId.LEAVE_REQUEST]: BlzCommandCode.LeaveRequest,
    [ZdoClusterId.NWK_UPDATE_REQUEST]: BlzCommandCode.ManagementNetworkUpdate,
...
export type BlzObjectPayload = any;
